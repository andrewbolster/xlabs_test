...
def build_argparser():
    ...
    parser.add_argument("-c", "--calicut", action='store', default=800, help="Estimated index of the end of Calibration")
...
def go(xlabscsv, calicut, invert_y=False, xlim=None, ylim=None, xslim=None, yslim=None, confidence_factor=None, **kwargs):
